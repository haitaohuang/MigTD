...
show_usage() {
    ...
    echo "  --mock-report                Use mock report data with test_mock_report feature (for testing)"
    ...
    echo "    example files in config/AzCVMEmu. Some reference values in those files for the tdServ may become"
