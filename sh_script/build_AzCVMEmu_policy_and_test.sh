...
#
TEST_CMD="./migtdemu.sh --policy-v2 --src-policy-file $OUTPUT_POLICY_A --src-policy-issuer-chain-file $OUTPUT_CERT_CHAIN_A --dst-policy-file $OUTPUT_POLICY_B --dst-policy-issuer-chain-file $OUTPUT_CERT_CHAIN_B --debug --both"
if [ "$USE_MOCK_REPORT" = true ]; then
