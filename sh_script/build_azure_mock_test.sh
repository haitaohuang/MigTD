...
#   ./sh_script/build_azure_mock_test.sh
#
#   # Mock mode: generate policy from predictable test data (uses test_mock_report)
#   ./sh_script/build_azure_mock_test.sh --mock-report
#
#   # Fetch fresh collaterals from Azure THIM before generating policy
#   ./sh_script/build_azure_mock_test.sh --fetch-collaterals --azure-region useast
#
#   # Skip the integration test at the end
#   ./sh_script/build_azure_mock_test.sh --skip-test
#
#   # Custom output directory
#   ./sh_script/build_azure_mock_test.sh --output-dir /path/to/output
#
#   # Show help
#   ./sh_script/build_azure_mock_test.sh --help
#
# What it does:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  $0 --mock-quote-file ./config/Azure/az_migtd_quote_v4.blob"
