...
pub async fn spdm_responder_transfer_msk(
    ...
    log::info!("BC> RSP-00 spdm_responder_transfer_msk: enter rsp_handle_message loop\n");
    Box::pin(rsp_handle_message(spdm_responder)).await?;
    log::info!("BC> RSP-99 spdm_responder_transfer_msk: rsp_handle_message exited cleanly\n");
...
pub fn handle_exchange_mig_attest_info_req(
    ...
    log::info!("BC> RSP-ATT-02 gen_quote_spdm done, len={}\n", quote_dst.len());
