...
mod v2 {
    ...
    fn authenticate_migration_dest(
        ...
        log::info!("BC> POL-DST-02 authenticate_remote_common ok suppl_data.len={}\n", suppl_data.len());
    ...
    fn authenticate_migration_source(
        ...
        log::info!("BC> POL-SRC-02 authenticate_remote_common ok suppl_data.len={}\n", suppl_data.len());
        let relative_reference = get_local_tcb_evaluation_info()?;
    ...
    fn authenticate_remote_common<'p>(
        ...
        log::info!("BC> POL-CMN-01 verify_quote begin quote.len={}\n", quote.len());
        let (fmspc, suppl_data) = verify_quote(quote, policy.get_collaterals())
            .map_err(|_| PolicyError::QuoteVerification)?;
        log::info!("BC> POL-CMN-02 verify_quote ok suppl_data.len={}\n", suppl_data.len());
